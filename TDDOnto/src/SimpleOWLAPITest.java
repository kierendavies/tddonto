...
public class SimpleOWLAPITest {
    ...
    // public SPARQLOWLTest() {
    //    this(null);
    // }

    public SimpleOWLAPITest(OWLOntologyManager manager, OWLOntology testedOntology, Reasoner reasoner2) {
        this.manager = manager;
        this.factory = manager.getOWLDataFactory();
        this.testedOntology = testedOntology;
        //      this.sparqlEngine=new OWLReasonerSPARQLEngine();
        // this.axiom = axiom;
        // this.reasoner = new Reasoner.ReasonerFactory().createReasoner(this.testedOntology);
...
//			manager.saveOntology(testedOntology);
    ...
    */
    public static void main(String[] args) throws Exception {
        ...
        Reasoner reasoner = new Reasoner(pizza);
